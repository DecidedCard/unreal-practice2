...
void AABCharacterBase::AttackHitCheck()
{
	...
	bool HitDetected = GetWorld()->SweepSingleByChannel(OutHitResult, Start, End, FQuat::Identity, CPROFILE_ABACTION, FCollisionShape::MakeSphere(AttackRadius), Params);
	if (HitDetected)
	{
...
{
	UE_LOG(LogABCharacter, Log, TEXT("Dring Potion"));
}
